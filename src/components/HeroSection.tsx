      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <a 
              href="#achievement-levels" 
              className="inline-flex items-center justify-center px-8 py-4 rounded-lg bg-gold text-navy font-semibold text-lg hover:bg-gold-light transition-all duration-300 glow-gold"
            >
              Start Your Journey
            </a>
            <a 
              href="#categories" 
              className="inline-flex items-center justify-center px-8 py-4 rounded-lg border-2 border-gold/30 text-primary-foreground font-semibold text-lg hover:bg-gold/10 hover:border-gold/50 transition-all duration-300"
            >
              Explore Categories
            </a>
          </div>
