...
const CertificatePreview = ({ template, studentName }: CertificatePreviewProps) => {
  ...
  const handleDownload = async () => {
    ...
    setDownloading(true);
    try {
      // Render the certificate div to canvas
      const canvas = await html2canvas(certificateRef.current, {
        scale: 3, // High resolution
        useCORS: true, // For images from /public
        allowTaint: true,
      });
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div ref={certificateRef} className="relative bg-white overflow-hidden shadow-2xl"
        style={{ width: '1122px', height: '794px' }} // ✅ A4 Landscape
      >
        {/* OUTER BORDER */}
        <div
        ...
        <div className="absolute inset-0 z-0">
          <div
            ...
            style={{ background: SCHOOL.blue, opacity: 0.15 }}
          />
          <div
            className="absolute top-40 -right-40 w-[700px] h-[700px] rounded-full blur-[120px]"
            style={{ background: SCHOOL.green, opacity: 0.12 }}
          />
          <div
            className="absolute bottom-0 left-1/4 w-[600px] h-[600px] rounded-full blur-[130px]"
        ...
        <div className="relative z-10 text-center pt-20">
          ...
          <h2 className="text-2xl tracking-widest uppercase" style={{ color: SCHOOL.blue }}>
            of Achievement
          </h2>
        </div>
        ...
        <div className="relative z-10 text-center mt-20 px-32">
          ...
          <div
            className="inline-block px-12 py-4 rounded-full border shadow-sm bg-white"
        ...
        <div className="absolute bottom-14 left-20 right-20 z-10 flex justify-between items-end">
          ...
          <div className="text-center">
            ...
            <span className="text-xs font-bold uppercase tracking-wide" style={{ color: SCHOOL.blue }}>
              Librarian
            </span>
          </div>
