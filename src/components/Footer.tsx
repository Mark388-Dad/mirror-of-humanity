      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <blockquote className="font-display text-2xl md:text-3xl italic text-primary-foreground/90 leading-relaxed">
            "Every story is a mirror; when we read, we find not only the world but also ourselves."
          </blockquote>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-display font-semibold">45-Book Reading Challenge</span>
