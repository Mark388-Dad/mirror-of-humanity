...
const Index = () => {
  ...
  return (
    <main className="min-h-screen relative">
      <SEOHead title="M-PESA Foundation Academy Reading Challenge" description="Join the MPESA Foundation Academy Reading Challenge. Track your reading progress, earn achievements, compete on leaderboards, and explore fiction as a mirror of humanity." path="/" />
